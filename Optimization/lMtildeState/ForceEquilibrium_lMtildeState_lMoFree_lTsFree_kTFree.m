...
function [err, FT] = ForceEquilibrium_lMtildeState_lMoFree_lTsFree_kTFree(a,lMtilde,vMtilde,lMT,lMo_lTs_kT_scaling,params,Fvparam,Fpparam,Faparam,Atendon,shift)
