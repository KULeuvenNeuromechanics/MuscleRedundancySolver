...
function [err, FT] = ForceEquilibrium_lMtildeState_lMoFree_lTsFree(a,lMtilde,vMtilde,lMT,lMo_lTs_scaling,params,Fvparam,Fpparam,Faparam,Atendon,shift)

FMo = params(:,1);
lMo = lMo_lTs_scaling(:,1).*params(:,2);
lTs = lMo_lTs_scaling(:,2).*params(:,3);
alphao = params(:,4);
Atendon = Atendon;
shift = shift;
