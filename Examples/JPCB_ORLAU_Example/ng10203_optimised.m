...
Misc.lb_lTs_scaling = 1.0; % Lower bound for scaling tendon slack length
Misc.ub_lTs_scaling = 1.0; % Upper bound for scaling tendon slack length
...
% Not sure if Misc.EMG_MuscleCopies works without a value due to line 87 in
% GetEMGInfo - Added JPCB 22/01/2020
...
Misc.MaxScaleEMG = 1.05; 			% maximal value to scale EMG

% Set weights
Misc.wEMG 		= 10;			% weight on tracking EMG
