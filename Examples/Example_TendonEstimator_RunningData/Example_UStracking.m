...
Misc.IKfile = {fullfile(DataPath,'PSF_IK_stride2.mot');fullfile(DataPath,'+8_IK_stride2.mot');fullfile(DataPath,'+15_IK_stride2.mot')};% fullfile(DataPath,'trial_2_IK.mot'); fullfile(DataPath,'trial_4_IK.mot')};
Misc.IDfile = {fullfile(DataPath,'PSF_ID_stride2.mot');fullfile(DataPath,'+8_ID_stride2.mot');fullfile(DataPath,'+15_ID_stride2.mot')};% fullfile(DataPath,'trial_2_ID.mot'); fullfile(DataPath,'trial_4_ID.mot')};
Misc.USfile = {fullfile(DataPath,'PSF_US_stride2.mot');fullfile(DataPath,'+8_US_stride2.mot');fullfile(DataPath,'+15_US_stride2.mot')};% fullfile(DataPath,'trial_2_US.mot'); fullfile(DataPath,'trial_4_US.mot')}; %
...
Misc.Estimate_OptFL = {'med_gas_l';'lat_gas_l'; 'soleus_l'};%;'lat_gas_l';'soleus_l'}; % Names of muscles of which optimal fiber length is estimated - slack length is estimated for these muscles as well
...
Misc.lb_lTs_scaling = 0.5; % Lower bound for scaling tendon slack length
...
Misc.USSelection = {'med_gas_l'; 'soleus_l'};
...
% Running the generic MRS can help start the parameter optimization from a
