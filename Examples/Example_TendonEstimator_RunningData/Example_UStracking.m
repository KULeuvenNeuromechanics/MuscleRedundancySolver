...
Misc.Estimate_OptimalFiberLength = {'med_gas_l';'lat_gas_l'; 'soleus_l'};%;'lat_gas_l';'soleus_l'}; % Names of muscles of which optimal fiber length is estimated - slack length is estimated for these muscles as well
