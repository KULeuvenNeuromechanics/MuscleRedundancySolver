...
%   vcemax: maximal muscle fiber velocities (default is 10)
...
function [energy_total,energy_am,energy_sl,energy_mech,energy_model] = ...
    getMetabolicEnergySmooth2010all(exc,act,lMtilde,vMtilde,vM,Fce,...
...
%% Mechanical work: different as compared to Umberger et al. (2003)
% Exclude negative mechanical work
